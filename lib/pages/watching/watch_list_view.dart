...
class WatchListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<WatchListViewModel>(
      create: (context) => new WatchListViewModel(),
  ...
  Widget buildCryptoListItem(BuildContext context, Ticker ticker) {
    ...
    return GestureDetector(
      onLongPress: () => Provider.of<WatchListViewModel>(context).selectTicker(ticker),
      child: Card(
                  ...
                  children: [
                    RichText(
                      text: TextSpan(children: [
                        TextSpan(style: style1, text: Provider.of<WatchListViewModel>(context).selectedTickers.contains(ticker.pair.key) ? 'O' : '.'),
